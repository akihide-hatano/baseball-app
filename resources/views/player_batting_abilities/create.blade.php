        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('players.batting-abilities.store', $player->id) }}">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="contact_power" class="block mt-1 w-full" type="number" name="contact_power" :value="old('contact_power')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('contact_power')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="power" :value="__('パワー')" />
                            <x-text-input id="power" class="block mt-1 w-full" type="number" name="power" :value="old('power')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('power')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="speed" :value="__('走力')" />
                            <x-text-input id="speed" class="block mt-1 w-full" type="number" name="speed" :value="old('speed')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('speed')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="fielding" :value="__('守備力')" />
                            <x-text-input id="fielding" class="block mt-1 w-full" type="number" name="fielding" :value="old('fielding')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('fielding')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="throwing" :value="__('肩力')" />
                            <x-text-input id="throwing" class="block mt-1 w-full" type="number" name="throwing" :value="old('throwing')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('throwing')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="reaction" :value="__('捕球/反応力')" />
                            <x-text-input id="reaction" class="block mt-1 w-full" type="number" name="reaction" :value="old('reaction')" min="0" max="100" />
                            <x-input-error :messages="$errors->get('reaction')" class="mt-2" />
                        </div>

                        <div class="mb-4">
                            <x-input-label for="overall_rank" :value="__('総合能力ランク')" />
                            <x-text-input id="overall_rank" class="block mt-1 w-full" type="number" name="overall_rank" :value="old('overall_rank')" min="0" max="100" />
