<x-app-layout>
    ...
    <div class="container mx-auto p-4">
        <h1 class="text-3xl font-bold mb-6 text-center text-blue-600">新しいプロ野球チームの登録</h1>

        <div class="max-w-xl mx-auto bg-white p-8 rounded-lg shadow-md">
            {{-- フォームの送信先は teams.store ルート --}}
            <form action="{{ route('teams.store') }}" method="POST">
                @csrf {{-- CSRFトークンはセキュリティのために必須 --}}
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="team_nickname" id="team_nickname" value="{{ old('team_nickname') }}"
